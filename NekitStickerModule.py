...
class StickersMod(loader.Module):
    ...
    strings = {"name": "NekitStickerMod",
               ...
               "what_pack": "<b>Ошибка: </b>❌ Не указано название стикерпака",
               "what_photo": "<b>ℹ️ Ответьте на стикер или фото, чтобы добавить его в стикерпак</b>",
               "not_animated_pack": "<b>Ошибка: </b>❌ Анимированные стикеры могут быть добавлены только в пакеты анимированных стикеров",
               "internal_error": "<b>🤔 Неизвестная внутренняя ошибка</b>",
               "bad_emojis": "<b>Ошибка: </b>❌ Недоступные эмодзи",
               "animated_pack": "<b>Ошибка: </b>❌ Статические стикеры не могут быть добавлены в пакеты анимированных стикеров",
               "new_pack": "ℹ️ Сначала создайте стикерпак",
               "pack_full": "<b>Ошибка: </b>❌ Стикерпак переполнен. Удалите несколько стикеров или создайте новы пакет",
               "added": "<b>✔️ Стикер добавлен в </b> <a href='{}'>стикерпак</a><b>!</b>",
               "bad_animated_sticker": "<b>ℹ️ Ответьте на анимированный стикер, чтобы конвертировать его в анимацию</b>"}
